...
public final class AIdentificadorVetorVar extends PVar
{
    private TIdentificador _identificador_;
    private final LinkedList<PExp> _indices_ = new LinkedList<PExp>();

    public AIdentificadorVetorVar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentificadorVetorVar(
    ...
    {
        ((Analysis) sw).caseAIdentificadorVetorVar(this);
    }
